...
func (t *TaskHandler) GetOpenedTask(ctx context.Context, request *proto.CommonRequest, response *proto.GetTaskResponse) error {
...
func (t *TaskHandler) GetOpenedTasks(ctx context.Context, request *proto.GetTasksRequest, response *proto.GetTasksResponse) error {
	var tmp []models.Task
